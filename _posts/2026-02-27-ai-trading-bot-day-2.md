---
title: "AI 트레이딩 봇 개발기 2일차 — 트레일링 스탑 구현과 AI 코드 리뷰"
description: "주식 단타 자동매매 봇에 트레일링 스탑을 구현하고, AI로 전체 시스템 코드 리뷰를 돌린 AI 트레이딩 봇 개발 2일차. 진짜 버그 3건과 오탐 21건으로 본 AI 코드 리뷰의 현실."
date: 2026-02-27
categories: [Project]
tags: [AI, Trading]
---
