---
title: "백준 16954번 움직이는 미로 탈출 — BFS DFS C++ 풀이"
description: "백준 16954번 움직이는 미로 탈출 풀이. 벽이 매 턴 아래로 내려오는 8×8 미로에서 9방향 이동과 벽 이동 순서를 처리해 탈출 가능 여부를 판별하는 BFS/DFS C++ 코드를 정리한다."
date: 2025-10-08
