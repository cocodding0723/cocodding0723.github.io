---
title: "AI 트레이딩 봇 개발기 8일차 — 코인 선물 청산 내역 DB 누락 버그 추적"
description: "코인 선물 자동매매 봇의 청산 내역을 추적하다 SQLite DB 기록 누락 버그를 발견하고, 로그와 DB를 교차 분석해 기록되지 않는 거래가 왜 위험한지 정리한 AI 트레이딩 봇 개발 8일차."
date: 2026-03-05
categories: [Project]
tags: [AI, Trading]
---
