...
categories: [Project]
tags: [Unity, C#, Game]
video_id: hp6LrmIztKU
video_title: "5일 만에 만든 카타나 제로 스타일 액션 게임 — 개발 영상"
video_description: "Unity로 5일간 만든 카타나 제로 스타일 액션 게임 플레이 영상. R3 반응형 아키텍처, FEEL 히트스톱, VFX Graph 타격 이펙트가 적용된 실제 빌드 데모."
video_upload_date: 2026-05-29
---
