---
title: "AI 트레이딩 봇 개발기 3일차 — 백테스트 프레임워크 구축과 자동 검증 훅"
description: "자동매매 전략을 바꾸기 전에 검증하는 백테스트 프레임워크를 하루 만에 구축하고, Claude Code 자동 검증 훅으로 안전장치를 만든 AI 트레이딩 봇 개발 3일차 기록."
date: 2026-02-28
categories: [Project]
tags: [AI, Trading]
---
